  ...
  template: `
      ...
      <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          ...
          <div class="bg-luxury-dark rounded-lg overflow-hidden shadow-luxury hover:shadow-gold-glow transition-all duration-300 group">
            <div class="aspect-square bg-gradient-to-br from-green-800 to-emerald-950 flex items-center justify-center relative overflow-hidden max-h-56 sm:max-h-64">
              <img src="https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=400&h=400&fit=crop" alt="Truffle Risotto with mushrooms" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300" />
              <div class="absolute inset-0 opacity-0 group-hover:opacity-30 bg-luxury-gold transition-opacity duration-300"></div>
            </div>
            <div class="p-4 sm:p-6">
              <h3 class="font-serif text-base sm:text-xl text-luxury-gold mb-2">Black Truffle Risotto</h3>
              <p class="text-white/60 text-xs sm:text-sm mb-4">Creamy arborio rice infused with black truffles, porcini mushrooms, and aged parmesan.</p>
              <p class="text-luxury-gold font-bold text-base sm:text-lg">₹4,316</p>
            </div>
          </div>

          <!-- Menu Item 2 -->
          <div class="bg-luxury-dark rounded-lg overflow-hidden shadow-luxury hover:shadow-gold-glow transition-all duration-300 group">
            <div class="aspect-square bg-gradient-to-br from-amber-700 to-orange-900 flex items-center justify-center relative overflow-hidden max-h-56 sm:max-h-64">
            ...
            <div class="p-4 sm:p-6">
              <h3 class="font-serif text-base sm:text-xl text-luxury-gold mb-2">Roasted Heirloom Vegetables</h3>
              <p class="text-white/60 text-xs sm:text-sm mb-4">Seasonal organic vegetables roasted in herb-infused oil with balsamic reduction and edible flowers.</p>
              <p class="text-luxury-gold font-bold text-base sm:text-lg">₹3,984</p>
            </div>
          </div>

          <!-- Menu Item 3 -->
          <div class="bg-luxury-dark rounded-lg overflow-hidden shadow-luxury hover:shadow-gold-glow transition-all duration-300 group">
            <div class="aspect-square bg-gradient-to-br from-purple-900 to-indigo-950 flex items-center justify-center relative overflow-hidden max-h-56 sm:max-h-64">
              <img src="https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=400&h=400&fit=crop" alt="Eggplant parmesan" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300" />
              <div class="absolute inset-0 opacity-0 group-hover:opacity-30 bg-luxury-gold transition-opacity duration-300"></div>
            </div>
            <div class="p-4 sm:p-6">
              <h3 class="font-serif text-base sm:text-xl text-luxury-gold mb-2">Eggplant Extravaganza</h3>
              <p class="text-white/60 text-xs sm:text-sm mb-4">Layered heirloom eggplant with buffalo mozzarella, fresh basil, and handmade pasta in truffle cream sauce.</p>
              <p class="text-luxury-gold font-bold text-base sm:text-lg">₹4,482</p>
            </div>
          </div>
        </div>
      ...
      <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="max-w-4xl mx-auto">
          <div class="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 gap-3 sm:gap-4">
            <!-- Gallery Item 1 -->
            <div class="relative rounded-lg overflow-hidden shadow-luxury group cursor-pointer max-h-64">
              <img src="https://images.unsplash.com/photo-1495521821757-a1efb6729352?w=300&h=300&fit=crop" alt="Gourmet Plating" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300" />
              <div class="absolute inset-0 bg-black/40 group-hover:bg-black/60 transition-all duration-300 flex items-center justify-center opacity-0 group-hover:opacity-100">
                <span class="text-white font-serif text-xs sm:text-base">Signature Plates</span>
              </div>
            </div>

            <!-- Gallery Item 2 -->
            <div class="relative rounded-lg overflow-hidden shadow-luxury group cursor-pointer max-h-64">
              <img src="https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=300&h=300&fit=crop" alt="Signature Dishes" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300" />
              <div class="absolute inset-0 bg-black/40 group-hover:bg-black/60 transition-all duration-300 flex items-center justify-center opacity-0 group-hover:opacity-100">
                <span class="text-white font-serif text-xs sm:text-base">Botanical Bliss</span>
              </div>
            </div>

            <!-- Gallery Item 4 -->
            <div class="relative rounded-lg overflow-hidden shadow-luxury group cursor-pointer max-h-64">
              <img src="https://images.unsplash.com/photo-1540189549336-e6e99c3679fe?w=300&h=300&fit=crop" alt="Organic Selection" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300" />
              <div class="absolute inset-0 bg-black/40 group-hover:bg-black/60 transition-all duration-300 flex items-center justify-center opacity-0 group-hover:opacity-100">
                <span class="text-white font-serif text-xs sm:text-base">Organic Excellence</span>
              </div>
            </div>

            <!-- Gallery Item 5 -->
            <div class="relative rounded-lg overflow-hidden shadow-luxury group cursor-pointer max-h-64">
              <img src="https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=300&h=300&fit=crop" alt="Wine Pairing" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300" />
              <div class="absolute inset-0 bg-black/40 group-hover:bg-black/60 transition-all duration-300 flex items-center justify-center opacity-0 group-hover:opacity-100">
                <span class="text-white font-serif text-xs sm:text-base">Collection</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
          ...
          <div class="relative rounded-lg overflow-hidden shadow-luxury group">
            <img src="https://images.unsplash.com/photo-1621996346565-e3dbc646d9a9?w=300&h=300&fit=crop" alt="Organic Legumes & Pulses" class="w-full h-auto aspect-square object-cover group-hover:scale-110 transition-transform duration-300" />
            <div class="p-4 sm:p-6 bg-luxury-dark">
              <h3 class="text-luxury-gold font-serif text-sm sm:text-lg mb-2">Organic Legumes & Pulses</h3>
              <p class="text-white/60 text-xs sm:text-sm">Hand-selected legumes and pulses with superior nutritional value and rich, complex flavors.</p>
            </div>
          </div>

          <!-- Ingredient 2 -->
          <div class="relative rounded-lg overflow-hidden shadow-luxury group">
            <img src="https://images.unsplash.com/photo-1540189549336-e6e99c3679fe?w=300&h=300&fit=crop" alt="Seasonal Vegetables" class="w-full h-auto aspect-square object-cover group-hover:scale-110 transition-transform duration-300" />
            <div class="p-4 sm:p-6 bg-luxury-dark">
              <h3 class="text-luxury-gold font-serif text-sm sm:text-lg mb-2">Seasonal Vegetables</h3>
              <p class="text-white/60 text-xs sm:text-sm">Farm-to-table fresh produce sourced from local organic farmers.</p>
            </div>
          </div>

          <!-- Ingredient 3 -->
          <div class="relative rounded-lg overflow-hidden shadow-luxury group">
            <img src="https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=300&h=300&fit=crop" alt="Curated Seasonings" class="w-full h-auto aspect-square object-cover group-hover:scale-110 transition-transform duration-300" />
            <div class="p-4 sm:p-6 bg-luxury-dark">
              <h3 class="text-luxury-gold font-serif text-sm sm:text-lg mb-2">Curated Seasonings</h3>
              <p class="text-white/60 text-xs sm:text-sm">Exotic spices and fresh herbs carefully selected for distinct flavors.</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <section class="relative bg-white py-20 lg:py-32 overflow-hidden">
      <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="relative">
          <!-- Scroll Container -->
          <div class="hidden lg:block overflow-x-auto overflow-y-hidden scrollbar-hide">
          ...
          <div class="lg:hidden overflow-y-auto max-h-96 scrollbar-hide">
            <div class="flex flex-col gap-6 pb-6">
              <!-- Event Card 1 -->
              <div class="w-full bg-white border border-gray-200 rounded-lg overflow-hidden shadow-luxury-sm hover:shadow-luxury transition-all duration-300 group cursor-pointer">
                <div class="relative overflow-hidden h-40">
                  <img src="https://images.unsplash.com/photo-1621996346565-e3dbc646d9a9?auto=format&fit=crop&w=400&h=200&q=80" alt="Wine Tasting Night" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300" />
                  <div class="absolute top-4 right-4 bg-luxury-gold text-black px-4 py-2 rounded-full text-xs font-bold">WINE</div>
                </div>
                <div class="p-4">
                  <h3 class="font-serif text-lg text-gray-900 mb-2">Wine Tasting & Pairing</h3>
                  <p class="text-gray-600 text-xs mb-3 line-clamp-2">Exclusive wine tasting with our sommelier pairing premium wines with our finest plant-based creations.</p>
                  <div class="flex items-center justify-between">
                    <div>
                      <p class="text-luxury-gold font-semibold text-xs">March 15, 2024</p>
                      <p class="text-gray-500 text-xs">7:00 PM</p>
                    </div>
                    <button class="text-luxury-gold hover:text-luxury-bronze text-xs font-semibold transition-colors">→</button>
                  </div>
                </div>
              </div>
              ...
              <div class="w-full bg-white border border-gray-200 rounded-lg overflow-hidden shadow-luxury-sm hover:shadow-luxury transition-all duration-300 group cursor-pointer">
                ...
                <div class="p-4">
                  <h3 class="font-serif text-lg text-gray-900 mb-2">Chef's Table Experience</h3>
                  <p class="text-gray-600 text-xs mb-3 line-clamp-2">Intimate 8-course tasting menu prepared directly in front of you by our master chef.</p>
                  <div class="flex items-center justify-between">
                    <div>
                      <p class="text-luxury-gold font-semibold text-xs">March 22, 2024</p>
                      <p class="text-gray-500 text-xs">7:30 PM</p>
                    </div>
                    <button class="text-luxury-gold hover:text-luxury-bronze text-xs font-semibold transition-colors">→</button>
                  </div>
              ...
              <div class="w-full bg-white border border-gray-200 rounded-lg overflow-hidden shadow-luxury-sm hover:shadow-luxury transition-all duration-300 group cursor-pointer">
                ...
                <div class="p-4">
                  <h3 class="font-serif text-lg text-gray-900 mb-2">Private Event Hosting</h3>
                  <p class="text-gray-600 text-xs mb-3 line-clamp-2">Host your celebration in our elegant private dining room with custom vegetarian menus.</p>
                  <div class="flex items-center justify-between">
                    <div>
                      <p class="text-luxury-gold font-semibold text-xs">Year-Round</p>
                      <p class="text-gray-500 text-xs">Custom Time</p>
                    </div>
                    <button class="text-luxury-gold hover:text-luxury-bronze text-xs font-semibold transition-colors">→</button>
                  </div>
              ...
              <div class="w-full bg-white border border-gray-200 rounded-lg overflow-hidden shadow-luxury-sm hover:shadow-luxury transition-all duration-300 group cursor-pointer">
                ...
                <div class="p-4">
                  <h3 class="font-serif text-lg text-gray-900 mb-2">Vegetarian Cooking Workshop</h3>
                  <p class="text-gray-600 text-xs mb-3 line-clamp-2">Learn signature vegetarian recipes and techniques from our award-winning culinary team.</p>
                  <div class="flex items-center justify-between">
                    <div>
                      <p class="text-luxury-gold font-semibold text-xs">April 5, 2024</p>
                      <p class="text-gray-500 text-xs">3:00 PM</p>
                    </div>
                    <button class="text-luxury-gold hover:text-luxury-bronze text-xs font-semibold transition-colors">→</button>
                  </div>
              ...
              <div class="w-full bg-white border border-gray-200 rounded-lg overflow-hidden shadow-luxury-sm hover:shadow-luxury transition-all duration-300 group cursor-pointer">
                ...
                <div class="p-4">
                  <h3 class="font-serif text-lg text-gray-900 mb-2">Farm-to-Table Experience</h3>
                  <p class="text-gray-600 text-xs mb-3 line-clamp-2">Visit our partner organic farms and see where our finest ingredients are sourced.</p>
                  <div class="flex items-center justify-between">
                    <div>
                      <p class="text-luxury-gold font-semibold text-xs">April 12, 2024</p>
                      <p class="text-gray-500 text-xs">9:00 AM</p>
                    </div>
                    <button class="text-luxury-gold hover:text-luxury-bronze text-xs font-semibold transition-colors">→</button>
                  </div>
